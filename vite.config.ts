...
function prerenderPlugin(): Plugin {
  ...
  const routes: RouteMeta[] = [
    ...
    { path: "/gallery", title: "הגלריה שלנו | המוסך של צביקה בגבעת שאול, ירושלים", description: "גלריית המוסך של צביקה בירושלים. בקרוב יתווספו תמונות אמיתיות מהמוסך, מהעבודה ומהשירות שאנחנו נותנים ביום יום." },
