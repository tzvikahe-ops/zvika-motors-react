...
function prerenderPlugin(): Plugin {
  ...
  const routes: RouteMeta[] = [
    ...
    { path: "/blog/כמה-עולה-טיפול-לרכב", title: "כמה עולה טיפול לרכב ומה משפיע על המחיר | בלוג המוסך של צביקה", description: "כמה עולה טיפול לרכב בישראל ב-2026? מחירי טיפול שוטף, בלמים, מזגן וטסט — ומה ההבדל בין מוסך עצמאי למוסך מורשה יצרן.", date: "2026-04-13" },
