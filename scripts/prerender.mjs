...
const routes = [
  ...
  { path: "/blog/musach-mumla-yerushalayim", title: "מוסך מומלץ בירושלים: המדריך לבחירה נכונה ב-2025 | בלוג המוסך של צביקה", description: "מחפשים מוסך מומלץ בירושלים? המדריך המלא לבחירה נכונה: מה לבדוק, אילו שאלות לשאול, וסימני אזהרה שחשוב להכיר. המוסך של צביקה, גבעת שאול.", date: "2026-04-06" },
