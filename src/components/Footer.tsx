          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3 mt-1">
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 bg-transparent border border-brand-red/50 hover:border-brand-red hover:bg-brand-red/10 text-brand-red px-4 py-2 rounded-full text-[12px] font-bold no-underline transition-all duration-200"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 bg-[#25D366]/12 hover:bg-[#25D366]/22 text-[#25D366] px-4 py-2 rounded-full text-[12px] font-bold no-underline transition-all duration-200"
              >
