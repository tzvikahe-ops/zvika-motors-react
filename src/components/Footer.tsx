          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3 mt-1">
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 bg-brand-red/12 hover:bg-brand-red/22 text-brand-red px-4 py-2 rounded-full text-[12px] font-bold no-underline transition-all duration-200"
              >
