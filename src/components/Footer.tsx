          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 bg-brand-red/15 hover:bg-brand-red/25 text-brand-red px-3 py-1.5 rounded-md text-[11px] font-bold no-underline transition-all duration-200 min-h-[36px]"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 bg-[#25D366]/15 hover:bg-[#25D366]/25 text-[#25D366] px-3 py-1.5 rounded-md text-[11px] font-bold no-underline transition-all duration-200 min-h-[36px]"
              >
