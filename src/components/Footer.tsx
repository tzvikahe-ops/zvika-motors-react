          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-5">
              ...
              <a
                ...
                className="text-primary-foreground/65 text-[12px] font-medium hover:text-primary-foreground/80 transition-colors no-underline inline-flex items-center gap-1.5"
              >
              ...
              {[
                ...
                <button
                  ...
                  onClick={() => setPage(page)}
                   className="block bg-transparent border-none text-primary-foreground/65 text-[12px] cursor-pointer py-1.5 text-right hover:text-primary-foreground/85 transition-colors duration-200"
                >
                  {label}
                </button>
              ))}
