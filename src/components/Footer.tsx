    ...
    <footer role="contentinfo" aria-label="תחתית האתר" className="bg-surface-darker relative" dir="rtl">
      ...
      <div className="max-w-[1100px] mx-auto px-5 sm:px-6 py-12 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-[1.3fr_1fr_0.8fr] gap-8 md:gap-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                aria-label="פנו אלינו בוואטסאפ (נפתח בחלון חדש)"
                className="inline-flex items-center gap-1.5 bg-white border border-[#0E7A6D] text-[#075E54] hover:bg-[#f0faf8] px-4 py-2 rounded-full text-[12px] font-bold no-underline transition-all duration-200 min-h-[44px]"
              >
              ...
              {/* Facebook */}
              <a
                href="https://www.facebook.com/profile.php?id=61578680494630"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center w-[38px] h-[38px] bg-transparent border border-primary-foreground/20 hover:border-[#1877F2] hover:bg-[#1877F2]/10 text-primary-foreground/60 hover:text-[#1877F2] rounded-full no-underline transition-all duration-200 min-h-[44px]"
                aria-label="עמוד הפייסבוק שלנו (נפתח בחלון חדש)"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="shrink-0"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
            </div>
          </div>
              ...
              {[
                ...
                <button
                  ...
                  onClick={() => setPage(page)}
                   className="block bg-transparent border-none text-primary-foreground/65 text-[12px] cursor-pointer py-2.5 px-1 min-h-[44px] inline-flex items-center text-right hover:text-primary-foreground/85 transition-colors duration-200"
                >
                  {label}
                </button>
              ))}
          ...
          {/* Info */}
          <div>
             <p className="text-primary-foreground/65 text-[12px] font-bold tracking-wider mb-3">פרטים</p>
      ...
      <div className="border-t border-primary-foreground/[0.04] py-4 md:py-5 px-5 sm:px-6">
        <div className="max-w-[1100px] mx-auto flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1">
          ...
          <p className="text-primary-foreground/55 text-[12px] sm:text-[13px]">
            מאז 1993
          </p>
        </div>
      </div>
