          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 bg-[#25D366] hover:bg-[#1ebe5b] text-white px-4 py-2 rounded-full text-[12px] font-bold no-underline transition-all duration-200 min-h-[44px]"
              >
