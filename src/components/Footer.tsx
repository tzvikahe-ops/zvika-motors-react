        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-[1.3fr_1fr_0.8fr] gap-8 md:gap-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-5">
              ...
              <a href="tel:02-6514446" onClick={() => trackPhoneClick("footer")} className="text-primary-foreground/70 text-[12px] font-bold hover:text-primary-foreground transition-colors no-underline inline-flex items-center gap-1.5 min-h-[44px] py-2">
              ...
              <a
                ...
                className="text-primary-foreground/65 text-[12px] font-medium hover:text-primary-foreground/80 transition-colors no-underline inline-flex items-center gap-1.5 min-h-[44px] py-2"
              >
              ...
              {[
                ...
                <button
                  ...
                  onClick={() => setPage(page)}
                   className="block bg-transparent border-none text-primary-foreground/65 text-[12px] cursor-pointer py-2.5 min-h-[44px] text-right hover:text-primary-foreground/85 transition-colors duration-200"
                >
                  {label}
                </button>
              ))}
