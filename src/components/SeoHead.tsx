...
const seoConfig: Record<string, PageSeo> = {
  ...
  "/gallery": {
    title: "הגלריה שלנו | המוסך של צביקה בגבעת שאול, ירושלים",
    description:
      "הצצה ראשונה למוסך של צביקה בגבעת שאול, ירושלים. תמונה אמיתית של חזית המוסך ברחוב האופה 4 - תמונות נוספות יתווספו בקרוב. צרו קשר בטלפון 02-6514446 או בוואטסאפ.",
