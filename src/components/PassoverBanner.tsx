...
export default function PassoverBanner() {
  ...
  return (
    <div
      className="fixed bottom-24 md:bottom-6 left-1/2 -translate-x-1/2 z-40 bg-[hsl(43,60%,85%)] text-[hsl(30,30%,18%)] py-1 px-3 text-[9px] md:text-[11px] font-bold rounded-lg shadow-md whitespace-nowrap"
      dir="rtl"
    >
