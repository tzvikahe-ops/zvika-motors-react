        ...
        <div className="text-center mb-5 md:mb-6">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2.5 bg-[#128C7E] text-black rounded-lg px-7 py-3.5 text-[14px] font-bold hover:bg-[#0e7a6d] transition-all duration-200 no-underline shadow-[0_4px_20px_-6px_rgba(18,140,126,0.35)] hover:-translate-y-px"
            >
