        ...
        <div className="text-center mb-5 md:mb-6">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2.5 bg-white border border-[#0E7A6D] text-[#075E54] rounded-lg px-7 py-3.5 text-[14px] font-bold hover:bg-[#f0faf8] transition-all duration-200 no-underline shadow-[0_2px_12px_-4px_rgba(7,94,84,0.2)] hover:-translate-y-px"
            >
        ...
        <div className="bg-card rounded-xl border-2 border-brand-red/20 shadow-[0_4px_24px_-8px_hsl(var(--brand-red)/0.12)] p-6 sm:p-8 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-5 md:gap-4">
            ...
            <a
              ...
              className="flex flex-col items-center text-center gap-2.5 group no-underline p-3 rounded-lg hover:bg-brand-red/[0.04] transition-colors"
            >
              <div className="w-14 h-14 rounded-2xl bg-brand-red/[0.1] flex items-center justify-center group-hover:bg-brand-red/[0.18] transition-colors">
                <PhoneIcon />
              </div>
              <div>
                <div className="font-black text-[15px] text-foreground leading-tight" dir="ltr">02-6514446</div>
                <div className="text-[11px] text-muted-foreground mt-1">חייגו עכשיו</div>
              </div>
            </a>
            ...
            >
                <div className="w-14 h-14 rounded-2xl bg-[#075E54]/10 flex items-center justify-center group-hover:bg-[#075E54]/20 transition-colors">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="#075E54">
                  <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" />
                </svg>
              </div>
              <div>
                <div className="font-black text-[15px] text-foreground leading-tight">וואטסאפ</div>
                <div className="text-[11px] text-muted-foreground mt-1">תשובה מהירה</div>
              </div>
            </a>
            ...
            >
              ...
              <div>
                <div className="font-black text-[15px] text-foreground leading-tight">נווטו אלינו</div>
                <div className="text-[11px] text-muted-foreground mt-1">Waze</div>
              </div>
            </a>

            {/* Address */}
            <div className="flex flex-col items-center text-center gap-2.5 p-3">
              <div className="w-14 h-14 rounded-2xl bg-brand-red/[0.1] flex items-center justify-center">
                <LocationIcon />
              </div>
              <div>
                <div className="font-bold text-[14px] text-foreground leading-tight">האופה 4, גבעת שאול</div>
                <div className="text-[11px] text-muted-foreground mt-1">ירושלים</div>
              </div>
            </div>

            {/* Hours */}
            <div className="flex flex-col items-center text-center gap-2.5 p-3 col-span-1 sm:col-span-2 md:col-span-1">
              <div className="w-14 h-14 rounded-2xl bg-brand-red/[0.1] flex items-center justify-center">
                <HoursIcon />
              </div>
              <div>
