        ...
        <div className="text-center mb-5 md:mb-6">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2.5 bg-[#128C7E] text-white rounded-lg px-7 py-3.5 text-[14px] font-bold hover:bg-[#0e7a6d] transition-all duration-200 no-underline shadow-[0_4px_20px_-6px_rgba(18,140,126,0.35)] hover:-translate-y-px"
            >
        ...
        <div className="bg-card rounded-xl border-2 border-brand-red/20 shadow-[0_4px_24px_-8px_hsl(var(--brand-red)/0.12)] p-6 sm:p-8 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-5 md:gap-4">
            ...
            <a
              ...
              className="flex flex-col items-center text-center gap-2.5 group no-underline p-3 rounded-lg hover:bg-[#25D366]/[0.04] transition-colors"
            >
