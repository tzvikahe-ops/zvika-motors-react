  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "המחיר תלוי בסוג הרכב, בשנת הייצור ובסוג הטיפול הנדרש. טיפול שוטף בסיסי (החלפת שמן ופילטרים) עולה בדרך כלל סביב 700 ש\"ח. אצלנו במוסך בגבעת שאול, ירושלים, נציג לכם הערכת מחיר לפני שמתחילים לעבוד.",
      },
    },
    {
      "@type": "Question",
