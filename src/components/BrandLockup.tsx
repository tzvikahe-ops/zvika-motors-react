    ...
    <>
      ...
      <div className="flex md:hidden items-center justify-center gap-1.5 max-w-full overflow-hidden">
          ...
          <div className="flex flex-col items-start justify-center gap-0.5">
            <span className="font-black text-brand-red text-[20px] leading-tight whitespace-nowrap">
              המוסך של צביקה
            </span>
            <p className="font-bold text-[14px] text-primary-foreground/90 leading-tight whitespace-nowrap m-0">
              אור-צת שירותי רכב
            </p>
          </div>
      </div>
