...
const WA_LINK = "https://wa.me/972526514446?text=שלום%2C%20ראיתי%20את%20המוסך%20של%20צביקה%20ואשמח%20לתאם%20תור%20ולקבל%20פרטים%20על%20השירותים%20שלכם%20%F0%9F%94%A7";
...
const AboutPage = () => {
  ...
  const milestones = [
    { year: "1993", text: "יהושע הרשקוביץ מקים את אור-צת שירותי רכב בגבעת שאול.", subtext: "מוסך ראשון בסוגו באזור שהתמחה בתאורה והצתה." },
    { year: "1998", text: "המוסך עובר לציוד דיאגנוסטיקה ממוחשבת, שנים לפני שזה הפך לסטנדרט בענף.", subtext: "התרחבות לשירותי מכונאות כללית לכל סוגי הרכב." },
    { year: "2004", text: "צביקה מצטרף למוסך ולומד את המקצוע לצד אביו יהושע.", subtext: "שני דורות, יחד, מטפלים ברכבים של אותן משפחות." },
    { year: "2011", text: "צביקה לוקח אחריות מלאה על ניהול המוסך.", subtext: "אותם ערכים, אותה כתובת, אותו צוות." },
    { year: "2026", text: "מעל 30 שנות ניסיון, 594 לקוחות שנסקרו, 96.1% מרוצים מאוד.", subtext: "98% חוזרים. ומביאים את הילדים שלהם." },
  ];
    ...
    <main dir="rtl" className="bg-background">
      ...
      <section className="relative pt-[68px] py-20 md:py-28 bg-surface-dark">
        ...
        <div className="max-w-[1100px] mx-auto px-5 sm:px-6 text-center relative z-10">
          ...
          <p className="about-summary text-[14px] md:text-[15px] text-primary-foreground/50 leading-[1.8] max-w-2xl mx-auto mb-8">
            המוסך של צביקה (אור-צת) הוא מוסך משפחתי בגבעת שאול, ירושלים.
            <br />מעל 30 שנה אנחנו מטפלים ברכבים של משפחות ירושלמיות,
            <br />ורובן עדיין אתנו. ומביאות גם את הילדים שלהן.
          </p>
          <div className="flex gap-3 flex-wrap justify-center">
            <a
              ...
              onClick={() => trackWhatsAppClick("about-hero")}
              className="inline-flex items-center justify-center gap-2 bg-white border border-[#0E7A6D] text-[#075E54] px-8 py-3.5 text-[13px] font-bold no-underline transition-all duration-200 shadow-[0_2px_12px_-4px_rgba(7,94,84,0.2)] hover:bg-[#f0faf8] hover:shadow-[0_4px_16px_-4px_rgba(7,94,84,0.3)] hover:-translate-y-px"
            >
              <WhatsAppSVG />
              דברו איתנו בוואטסאפ
            ...
            <InternalLink
              page="contact"
              className="inline-flex items-center justify-center gap-2 bg-primary-foreground/[0.06] text-primary-foreground border border-primary-foreground/10 px-8 py-3.5 text-[13px] font-bold hover:bg-primary-foreground/[0.1] transition-all duration-200 no-underline"
            >
              לתיאום בדיקה
            </InternalLink>
          </div>
      ...
      <section className="py-16 md:py-24 bg-background" aria-label="הסיפור של המוסך">
        <div className="max-w-[800px] mx-auto px-5 sm:px-6">
          ...
          {/* Story CTA */}
          <div className="mt-8 p-5 bg-surface-warm border border-border rounded-lg text-center">
            <p className="text-foreground/70 text-[13px] md:text-[14px] leading-[1.8] mb-4">
              רוצים להכיר אותנו? בואו לבקר או שלחו הודעה בוואטסאפ.
            </p>
            <a
              href={WA_LINK}
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => trackWhatsAppClick("about-story")}
              className="inline-flex items-center justify-center gap-2 bg-white border border-[#0E7A6D] text-[#075E54] px-6 py-3 text-[13px] font-bold no-underline transition-all duration-200 shadow-[0_2px_12px_-4px_rgba(7,94,84,0.2)] hover:bg-[#f0faf8] hover:-translate-y-px"
            >
              <WhatsAppSVG />
              דברו איתנו
              <span className="sr-only">(נפתח בחלון חדש)</span>
      ...
      <section className="py-16 md:py-24 bg-surface-warm" aria-label="הערכים שלנו">
        <div className="max-w-[1100px] mx-auto px-5 sm:px-6">
          <div className="flex items-center gap-3 mb-4 justify-center">
            <div className="w-10 h-[2px] bg-brand-red/50" />
            <p className="text-brand-red text-[12px] font-bold tracking-[0.15em] uppercase">מה מנחה אותנו</p>
            <div className="w-10 h-[2px] bg-brand-red/50" />
          </div>
      ...
      {/* 4. ABOUT ZVIKA - Personal */}
      <section className="py-16 md:py-24 bg-surface-steel" aria-label="על צביקה">
        <div className="max-w-[800px] mx-auto px-5 sm:px-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-[2px] bg-brand-red/50" />
            <p className="text-brand-red text-[12px] font-bold tracking-[0.15em] uppercase">הצוות</p>
          </div>
          <h2 className="text-[24px] sm:text-[28px] md:text-[34px] font-black text-foreground mb-8 tracking-[-0.03em] leading-[1.15]">
              ...
              {milestones.map((m) => (
                <div key={m.year} className="flex items-start gap-5 relative">
                  ...
                  <div className="bg-card border border-border rounded-lg p-4 md:p-5 flex-1 hover:border-brand-red/20 transition-colors">
                    ...
                    <p className="text-muted-foreground text-[12px] md:text-[13px] leading-[1.7] mt-1">{m.subtext}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      {/* 7. SEO BRIDGE - "מחפשים מוסך אור-צת?" */}
      <section className="py-16 md:py-20 bg-surface-warm" aria-label="מחפשים מוסך אור צת">
        <div className="max-w-[800px] mx-auto px-5 sm:px-6">
          <div className="p-6 bg-card border border-border rounded-lg">
            ...
            <p className="text-foreground/60 text-[13px] md:text-[14px] leading-[2]">
              <strong className="text-foreground/80">מוסך אור צת</strong> ו-<strong className="text-foreground/80">אור צת שירותי רכב</strong> - זה אנחנו. המוסך נוסד ב-1993 בגבעת שאול על ידי יהושע הרשקוביץ תחת השם{"\n"}"אור-צת שירותי רכב", ומאז 2011 מנוהל על ידי בנו, <strong className="text-foreground/80">צביקה הרשקוביץ</strong>. הכתובת זהה: <strong className="text-foreground/80">רחוב האופה 4, גבעת שאול, ירושלים</strong>. אם הכרתם אותנו בשם הישן - ברוכים השבים. אם זו הפעם הראשונה שאתם שומעים עלינו - ברוכים הבאים.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-background" aria-label="מיקום המוסך">
        <div className="max-w-[800px] mx-auto px-5 sm:px-6">
          <div className="flex items-center gap-3 mb-4 justify-center">
            <div className="w-10 h-[2px] bg-brand-red/50" />
            <p className="text-brand-red text-[12px] font-bold tracking-[0.15em] uppercase">איפה אנחנו</p>
            <div className="w-10 h-[2px] bg-brand-red/50" />
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="text-brand-red text-[13px] font-bold no-underline hover:text-brand-red-hover transition-colors">052-651-4446 <span className="sr-only">(נפתח בחלון חדש)</span></a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 md:py-20 bg-surface-dark" aria-label="יצירת קשר">
        <div className="max-w-[1100px] mx-auto px-5 sm:px-6 text-center">
          ...
          <div className="flex gap-3 flex-wrap justify-center">
            ...
            <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-primary-foreground/[0.06] text-primary-foreground border border-primary-foreground/10 px-8 py-3.5 rounded-md font-medium text-[15px] hover:bg-primary-foreground/[0.1] transition-all duration-200 no-underline">
