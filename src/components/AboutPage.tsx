...
const AboutPage = () => {
  const values = [
    ...
    { icon: <Heart className="w-5 h-5" />, title: "יחס אישי", description: "צביקה נמצא במוסך כל יום ומכיר כל לקוח בשם. כשאתם מתקשרים – אתם מדברים ישירות עם בעל המקצוע, לא עם מוקד שירות." },
    ...
    <main dir="rtl" className="bg-background">
      ...
      <section className="py-16 md:py-24 bg-background" aria-label="הסיפור של המוסך">
        <div className="max-w-[800px] mx-auto px-5 sm:px-6">
          ...
          <div className="text-foreground/60 text-[13px] md:text-[14px] leading-[2.1] space-y-5">
            <p>
              הסיפור שלנו מתחיל ב-1993, כשיהושע הרשקוביץ פתח מוסך קטן ברחוב האופה בגבעת שאול, ירושלים. מההתחלה, העיקרון המנחה היה פשוט: לתת שירות ישר, הוגן ומקצועי. לא להמציא תקלות, לא לחייב על מה שלא צריך, ולהתייחס לכל רכב כאילו הוא שלך.
            </p>
            <p>
              בנו, צביקה, גדל במוסך. כילד הוא שיחק בין הכלים וצפה באביו עובד. עם השנים, הסקרנות הפכה לתשוקה, והתשוקה למקצוע. צביקה למד מכונאות רכב מהשטח – לא רק מספרים, אלא מידיים שמחליפות חלקים, מאוזניים שמקשיבות למנוע, ומניסיון שנצבר רכב אחרי רכב.
            </p>
            <p>
              היום צביקה מנהל את המוסך ומביא איתו את כל מה שלמד מאביו: את היושר, את הדקדקנות ואת המחויבות ללקוח. הוא מכיר את הלקוחות שלו בשם, זוכר את ההיסטוריה של כל רכב, ותמיד זמין לשיחת ייעוץ – גם בטלפון, גם בוואטסאפ.
            </p>
            <p>
              המוסך השתדרג לאורך השנים עם ציוד דיאגנוסטי ממוחשב מתקדם, אבל דבר אחד לא השתנה: היחס האישי. אצלנו אין מערכת תורים אלקטרונית ואין מוקד שירות. כשאתם מתקשרים – אתם מדברים עם צביקה. כשאתם מגיעים – צביקה בודק לכם את הרכב.
            </p>
            <p>
      ...
      <section className="py-16 md:py-24 bg-surface-steel" aria-label="על צביקה">
        <div className="max-w-[800px] mx-auto px-5 sm:px-6">
          ...
          <div className="text-foreground/60 text-[13px] md:text-[14px] leading-[2.1] space-y-5">
            <p>
              צביקה גדל במוסך של אביו מגיל צעיר. הוא למד את עולם הרכב מתוך אהבה אמיתית למקצוע – לא כדי לעבוד "על הרכב" אלא כדי לעזור לאנשים. הוא מאמין שמכונאי טוב הוא לא רק מי שיודע לתקן, אלא מי שיודע להסביר, להיות ישר ולתת ללקוח הרגשה שהוא בידיים טובות.
            </p>
            <p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/972526514446" target="_blank" rel="noopener noreferrer" className="text-brand-red text-[13px] font-bold no-underline hover:text-brand-red-hover transition-colors">052-651-4446</a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 md:py-20 bg-surface-warm" aria-label="מידע נוסף">
        <div className="max-w-[800px] mx-auto px-5 sm:px-6">
          ...
          <div className="text-foreground/55 text-[13px] md:text-[14px] leading-[2] space-y-4">
            <p>
              המוסך של צביקה, הפועל תחת השם אור-צת שירותי רכב, הוא מוסך מקצועי ומורשה בירושלים המתמחה במכונאות רכב כללית, דיאגנוסטיקה ממוחשבת, טיפול במערכות מיזוג אוויר לרכב והכנה לטסט שנתי. המוסך ממוקם ברחוב האופה 4 בגבעת שאול ומשרת לקוחות מכל רחבי ירושלים והסביבה.
            </p>
            <p>
              המוסך הוקם בשנת 1993 על ידי יהושע הרשקוביץ וכיום מנוהל על ידי בנו צביקה. לאורך מעל שלושה עשורים של פעילות, המוסך בנה מוניטין של אמינות, מקצועיות ושירות אישי. לקוחות המוסך נהנים משקיפות מלאה בכל תהליך הטיפול, מחירים הוגנים ואחריות על כל עבודה.
            </p>
            <p>
              בין השירותים המוצעים: טיפולים שוטפים (החלפת שמן מנוע ופילטרים), תיקוני מנוע ומערכת בלמים, דיאגנוסטיקה ממוחשבת לאיתור תקלות, טיפול במערכת מיזוג אוויר (מילוי גז, איתור דליפות, תיקון מדחס), הכנה מקיפה לטסט שנתי, בדיקת רכב לפני קנייה, החלפת רצועת תזמון, טיפול במערכת קירור ועוד. המוסך מצויד בציוד סריקה ודיאגנוסטיקה מתקדם ומשתמש בחלפים מקוריים ותחליפיים באיכות גבוהה.
            </p>
          </div>
        </div>
      </section>
