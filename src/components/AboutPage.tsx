  ...
  return (
    <main dir="rtl" className="bg-background">
      ...
      <section className="py-16 md:py-24 bg-background" aria-label="הסיפור של המוסך">
        <div className="max-w-[800px] mx-auto px-5 sm:px-6">
          ...
          <div className="text-foreground/60 text-[13px] md:text-[14px] leading-[2.1] space-y-5">
            <p>
              הסיפור שלנו מתחיל ב-1993, כשיהושע הרשקוביץ, בעל נסיון עשיר בהנדסת מכונות, פתח מוסך קטן ברחוב בית הדפוס בגבעת שאול, ירושלים. מההתחלה, העיקרון המנחה היה פשוט: לתת שירות ישר, הוגן ומקצועי. לא להמציא תקלות, לא לחייב על מה שלא צריך, ולהתייחס לכל רכב כאילו הוא שלך.
            </p>
            <p>
      ...
      <section className="py-16 md:py-20 bg-surface-warm" aria-label="מידע נוסף">
        <div className="max-w-[800px] mx-auto px-5 sm:px-6">
          <h2 className="text-[20px] md:text-[24px] font-bold text-foreground mb-6 tracking-[-0.02em]">אודות המוסך של צביקה (אור-צת שירותי רכב)</h2>
          <div className="text-foreground/55 text-[13px] md:text-[14px] leading-[2] space-y-4">
            <p>
              <strong className="text-foreground/80">מוסך אור-צת</strong> — המוסך של צביקה — הוא מוסך משפחתי מקצועי בירושלים שהוקם בשנת 1993 על ידי יהושע הרשקוביץ תחת השם <strong className="text-foreground/80">אור-צת שירותי רכב</strong>. במשך יותר מ-30 שנה, השם "אור צת" הפך לסמל של אמינות ומקצועיות בגבעת שאול ובכל ירושלים.
            </p>
            <p>
              כיום מנוהל <strong className="text-foreground/80">מוסך אור צת</strong> על ידי צביקה הרשקוביץ, שגדל במוסך של אביו ולמד את המקצוע מהשטח. צביקה מכיר את כל לקוחותיו בשם, זמין לשיחת ייעוץ בכל עת ועומד באופן אישי מאחורי כל טיפול. הגישה שלו פשוטה: להיות ישרים, להסביר הכל, ולעשות רק מה שבאמת צריך.
            </p>
            <p>
              <strong className="text-foreground/80">אור-צת שירותי רכב</strong> ממוקם ברחוב האופה 4 (בית הדפוס 24) בגבעת שאול, ירושלים, ומשרת לקוחות מכל רחבי העיר ומהסביבה — מבשרת ציון, מעלה אדומים ובית שמש. עם 98% לקוחות חוזרים ודירוג 4.8 בגוגל מעל 107 ביקורות, זהו מוסך שהלקוחות ממליצים עליו בחום.
            </p>
            <p>
              מחפשים <strong className="text-foreground/80">מוסך אור צת</strong> בירושלים? זה אנחנו. אותו מוסך, אותו צוות, אותה מקצועיות — עכשיו תחת השם המוסך של צביקה (אור-צת).
            </p>
          </div>
          {/* Internal links */}
