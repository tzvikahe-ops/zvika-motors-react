      ...
      <section className="py-16 md:py-24 bg-background" aria-label="הסיפור של המוסך">
        <div className="max-w-[800px] mx-auto px-5 sm:px-6">
          ...
          <div className="text-foreground/60 text-[13px] md:text-[14px] leading-[2.1] space-y-5">
            <p>
              הסיפור שלנו מתחיל ב-1993, כשיהושע הרשקוביץ פתח מעבדת שירותים לתאורה והצתה ברחוב בית הדפוס בגבעת שאול, ירושלים. השם "אור-צת" לא נבחר במקרה — "אור" עבור תאורה, "צת" עבור הצתה. כי זה היה הלב הטכני של הרכב של אותם ימים.
            </p>
            <p>
            ...
            <p>
              חשוב לנו לומר גם מה <strong className="text-foreground/80">לא</strong> עושים אצלנו: פחח וצבע, זגגות, אבזור ומיגון — אלה לא ברשימת השירותים שלנו, מסיבות לוגיסטיות בלבד. הלקוחות שלנו יודעים לאן לפנות לכל שירות, ואנחנו שמחים להמליץ.
            </p>
            <p>
