...
export default function MapSection() {
  return (
    <section className="bg-gray-bg py-20 md:py-28 px-6" dir="rtl" aria-label="מצאו אותנו על המפה">
      <div className="max-w-[1100px] mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-sm max-w-lg mx-auto leading-relaxed">
            אור-צת שירותי רכב ממוקמים ברחוב האופה 4, ירושלים. לחצו לניווט ישיר ב-Waze או פתחו את המיקום ב-Google Maps והגיעו אלינו בקלות.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
          {/* Map embed */}
          <div className="rounded-xl overflow-hidden shadow-[var(--shadow-md)] border border-border/60 min-h-[320px]">
            <iframe
          ...
          {/* Info card */}
          <div className="bg-background rounded-xl p-8 md:p-10 shadow-[var(--shadow-md)] border border-border/60 flex flex-col justify-between gap-6">
            <div>
              <h3 className="font-extrabold text-xl text-primary mb-5">אור-צת שירותי רכב</h3>

              <div className="flex items-start gap-3 mb-4">
                <MapPin size={20} className="text-brand-red mt-0.5 shrink-0" />
                <div>
                  <p className="font-bold text-sm text-primary">האופה 4, ירושלים</p>
                  <p className="text-muted-foreground text-xs mt-0.5">גבעת שאול, בית הדפוס 24</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                <Navigation size={18} className="text-brand-red shrink-0" />
