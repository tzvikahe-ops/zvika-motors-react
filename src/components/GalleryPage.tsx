          ...
          <div className="bg-muted/50 border border-border rounded-xl px-8 py-10">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 text-[12px] font-medium text-white bg-[#128C7E] rounded-full px-4 min-h-[36px] hover:bg-[#0e7a6d] transition-colors"
              >
        ...
        <div className="max-w-[560px] mx-auto mt-12 text-center">
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            <a
              ...
              className="inline-flex items-center gap-2 text-[13px] font-bold text-white bg-[#128C7E] rounded-md px-6 min-h-[44px] hover:bg-[#0e7a6d] transition-colors no-underline"
            >
