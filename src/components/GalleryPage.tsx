        ...
        <div className="max-w-[560px] mx-auto mt-12 text-center">
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 text-[13px] font-medium text-foreground/70 bg-transparent border border-border rounded-md px-6 min-h-[44px] hover:border-brand-red/30 hover:text-brand-red cursor-pointer transition-colors"
            >
              <Phone className="w-3.5 h-3.5" />
              צרו קשר ותאמו תור
            </button>
