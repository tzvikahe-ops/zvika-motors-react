  ...
  const serviceTemplates = [
    {
      ...
      description: "בדיקות שגרתיות, שמנים ופילטרים לפי הוראות יצרן.",
    },
    {
      title: "דיאגנוסטיקה מתקדמת",
      description: "איתור תקלות ממוחשב ומדויק עם דוחות ברורים.",
    },
    {
      title: "מיזוג אוויר לרכב",
      description: "בדיקה, מילוי ותיקון מערכת קירור.",
    },
  ];
