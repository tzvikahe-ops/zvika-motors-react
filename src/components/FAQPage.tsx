        ...
        <div className="max-w-[600px] mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-[#128C7E] hover:bg-[#0e7a6d] text-white px-8 py-3.5 rounded-md font-bold text-[14px] no-underline transition-all duration-200 shadow-[0_4px_24px_-6px_rgba(18,140,126,0.35)]"
            >
              <WhatsAppSVG />
              שאלו אותנו בוואטסאפ
