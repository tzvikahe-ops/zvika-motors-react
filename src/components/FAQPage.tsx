...
const faqs: FAQItem[] = [
  ...
  // — עלויות וזמנים —
  {
    ...
    answer: "תלוי בסוג הרכב ובשנת הייצור. טיפול בסיסי (שמן ופילטרים) נע בדרך כלל בין 250 ל-500 ש\"ח. תמיד נגיד לכם את המחיר המדויק לפני שמתחילים - בלי הפתעות בחשבונית.",
    links: [{ text: "קבלו הצעת מחיר", page: "contact" }],
  },
  {
    question: "כמה זמן לוקח טיפול שוטף?",
    answer: "טיפול בסיסי (שמן ופילטרים) לוקח כשעה עד שעתיים. טיפולים מורכבים יותר כמו החלפת בלמים או תיקון מנוע יכולים לקחת יום עבודה. תמיד נעדכן אתכם מראש כמה זמן לחכות.",
  },
  {
