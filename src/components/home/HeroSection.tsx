        ...
        <div className="relative z-10 bg-surface-darker flex flex-col justify-center order-2 md:order-1">
          ...
          <div className="relative px-6 sm:px-10 md:px-12 lg:px-16 py-20 md:py-0">
            ...
            <p className="text-primary-foreground/70 text-[14px] md:text-[15px] leading-[1.9] mb-6 md:mb-8 max-w-[420px]">
              מוסך מקצועי בגבעת שאול, ירושלים. צוות המוסך מטפל ברכב שלכם במקצועיות, מסביר מה נדרש לפני שמתקדמים, ומעדכן בשקיפות לאורך הטיפול. בלי עבודות מיותרות ובלי להשאיר אתכם בחוסר ודאות.
            </p>
