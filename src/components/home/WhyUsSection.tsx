...
const points = [
  { num: "01", title: "ניסיון של מעל 30 שנה", desc: "אנחנו מכירים כל רכב, כל מנוע וכל תקלה. הידע הזה מאפשר לנו לעבוד מהר, בדיוק, ובלי ניחושים." },
  { num: "02", title: "שקיפות מוחלטת", desc: "לפני שמתחילים, מסבירים בדיוק מה צריך ולמה. תמיד תדעו מה קורה עם הרכב ומה העלות." },
  { num: "03", title: "אחריות אישית", desc: "צביקה עומד מאחורי כל עבודה באופן אישי. אחריות מלאה על חלקים, עבודה ושירות." },
];
