      ...
      <main dir="rtl" className="bg-background">
        ...
        <section className="relative pt-[68px] py-20 md:py-28 bg-surface-dark">
          ...
          <div className="max-w-[1100px] mx-auto px-5 sm:px-6 text-center relative z-10">
            <div className="inline-flex items-center gap-2 bg-brand-red/20 text-brand-red text-[11px] font-bold px-3 py-1 rounded-full mb-5 tracking-wider">מיזוג אוויר לרכב</div>
            <h1 className="text-[28px] sm:text-[34px] md:text-[42px] font-black text-primary-foreground mb-5 leading-tight tracking-[-0.03em]">
              טיפול במיזוג אוויר לרכב בירושלים
            </h1>
            <p className="text-[14px] md:text-[15px] text-primary-foreground/50 mb-9 max-w-2xl mx-auto leading-[1.8]">
              מילוי גז, איתור דליפות ותיקון מערכות קירור. נדאג שתיהנו מנסיעה נעימה גם בימי הקיץ החמים בירושלים.
            </p>
            <a
              href="https://wa.me/972526514446?text=שלום%2C%20אשמח%20לתאם%20טיפול%20מיזוג%20אוויר%20לרכב"
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => trackWhatsAppClick("ac-hero")}
          ...
          <div className="max-w-[1100px] mx-auto px-5 sm:px-6">
            ...
            <nav aria-label="breadcrumb" className="mb-5" dir="rtl">
              <ol className="flex flex-wrap items-center gap-1 text-[11px] text-muted-foreground">
                ...
                <li aria-hidden="true" className="mx-0.5 select-none">›</li>
                <li className="text-foreground/70" aria-current="page">מיזוג אוויר לרכב</li>
              </ol>
            </nav>
            <article className="bg-card border border-border rounded-lg overflow-hidden">
              <div className="p-6 md:p-8">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    <h2 className="text-[18px] md:text-[20px] font-bold text-foreground tracking-[-0.02em]">מיזוג אוויר לרכב</h2>
                    <p className="text-brand-red text-[12px] font-medium mt-0.5">טיפול מלא במערכת הקירור והחימום</p>
                  </div>
                </div>
                ...
                <div className="bg-brand-red/[0.04] border border-brand-red/10 rounded-md px-4 py-3 mb-5">
                  <p className="text-foreground/70 text-[12px] md:text-[13px] leading-[1.7]">
                    ...
                    המזגן לא מקרר כמו פעם, יוצא ממנו ריח לא נעים, או שנשמעים רעשים מהמערכת.
                  </p>
                </div>
        ...
        <section className="py-16 md:py-20 bg-surface-dark" aria-label="קבעו טיפול">
          <div className="max-w-[1100px] mx-auto px-5 sm:px-6 text-center">
            <h2 className="text-[22px] md:text-[32px] font-black text-primary-foreground mb-3 tracking-[-0.03em]">המזגן לא מקרר? דברו איתנו</h2>
            <p className="text-primary-foreground/45 mb-9 text-[13px] md:text-[14px] leading-[1.8] max-w-md mx-auto">
              שלחו הודעה קצרה ונחזור אליכם עם הערכה ראשונית בלי עלות.
            </p>
            <div className="flex gap-3 flex-wrap justify-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => trackWhatsAppClick("ac-cta")}
                className="inline-flex items-center gap-2 bg-white border border-[#0E7A6D] text-[#075E54] hover:bg-[#f0faf8] px-8 py-3.5 rounded-md font-bold text-[15px] transition-all duration-200 shadow-[0_2px_12px_-4px_rgba(7,94,84,0.2)] no-underline"
              >
                <WhatsAppSVG />
                שלחו הודעה בוואטסאפ
              ...
              <a
                href="tel:02-6514446"
                onClick={() => trackPhoneClick("ac-cta")}
