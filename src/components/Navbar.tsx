  ...
  return (
    ...
    >
      <div className="max-w-[1100px] mx-auto px-2 sm:px-6 flex items-center justify-start lg:justify-between gap-0 lg:gap-0 h-[60px] lg:h-[90px]">
        ...
        <a
          href="tel:02-6514446"
          onClick={() => trackPhoneClick("navbar-mobile-icon")}
          className="lg:hidden shrink-0 min-w-[44px] min-h-[44px] flex items-center justify-center text-brand-red no-underline"
        ...
        <div className="hidden lg:flex items-center gap-1 whitespace-nowrap">
          ...
          <a
            ...
            className="btn-primary no-underline text-[13px] inline-flex items-center gap-1.5 min-h-[44px] !py-2 !px-4 !rounded-lg"
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center w-[38px] h-[38px] bg-[#25D366] rounded-lg hover:bg-[#1EBE5A] transition-all duration-200 hover:-translate-y-px no-underline"
        ...
        <div className="lg:hidden bg-surface-darker px-5 py-4 flex flex-col gap-1 border-t border-primary-foreground/[0.06]">
          ...
          <div className="mt-3 pt-3 border-t border-primary-foreground/[0.06] flex gap-3">
            ...
            <a
              ...
              className="flex-1 no-underline text-[14px] inline-flex items-center justify-center gap-2 bg-[#25D366] text-white py-3.5 px-4 font-bold rounded-sm hover:bg-[#1EBE5A] transition-colors"
            >
