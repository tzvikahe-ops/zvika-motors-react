...
export default function Navbar({ currentPage, setPage }: NavbarProps) {
  ...
  return (
    <nav
      ...
      dir="rtl"
    >
      <div className="max-w-[1100px] mx-auto px-3 sm:px-6 relative flex items-center justify-center md:justify-between h-[78px] md:h-[72px]">
        <button
        ...
        <button
          ...
          className="md:hidden absolute right-3 top-1/2 -translate-y-1/2 bg-transparent border-none cursor-pointer text-primary-foreground p-1"
        >
