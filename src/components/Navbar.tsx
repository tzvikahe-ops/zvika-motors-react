...
export default function Navbar({ currentPage, setPage, bannerVisible }: NavbarProps) {
  ...
  return (
    <nav
      className="fixed top-[40px] md:top-[36px] left-0 right-0 z-50 bg-surface-darker/95 backdrop-blur-md border-b border-primary-foreground/[0.06] overflow-x-hidden"
      dir="rtl"
    >
        ...
        <div className="hidden md:flex items-center gap-1 whitespace-nowrap">
          ...
          <a
            ...
            className="text-brand-red text-[13px] font-bold no-underline hover:text-brand-red-hover transition-colors duration-200 inline-flex items-center gap-1.5 min-h-[44px] min-w-[44px] py-2 px-2"
          >
        ...
        <div className="md:hidden bg-surface-darker px-5 py-4 flex flex-col gap-1 border-t border-primary-foreground/[0.06]">
          ...
          <div className="mt-3 pt-3 border-t border-primary-foreground/[0.06] flex gap-3">
            ...
            <a
              ...
              className="btn-outline-dark flex-1 no-underline text-[14px] inline-flex items-center justify-center gap-2"
            >
